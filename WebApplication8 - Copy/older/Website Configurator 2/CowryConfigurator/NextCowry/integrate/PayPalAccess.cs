...
namespace NextCowry.integrate
{
    public class PayPalAccess
    {
        ...
        public string ProcessSalesTransaction2(string firstName, string lastName, string totalAmt, DateTime creditCardExpirationDate,
                string creditCardNumber, string cCAuthCode, string invoiceId, string email, string phone, string address, string address2, string city, string zip, string state, string country)
        {
            ...
            Currency Amt = new Currency(decimal.Parse(TotalAmount.ToString("00.00")), "USD");
            Inv.Amt = Amt;
