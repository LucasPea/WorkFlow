                            ...
                            if (renderBody != null) {
                                for (var propN in jsn[auxy[i]].inputs.body) {
                                    ...
                                    if (this.checkPermission(propN)) {
                                        ...
                                        lb_msg += "" + propN.toUpperCase()  + ": <span style='width:100%' id='txt" + auxy[i] + "_" + propN + "'> " + jsn[auxy[i]].inputs.body[propN] + "</span>";
                                    }
                                    indice++;
                                }
                                lb_msg += "</div>";
                                                ...
                                                for (var porpNJPE in jsn[auxy[i]][propN][propNJ]) {
                                                    for (var porpNJE in jsn[auxy[i]][propN][propNJ][porpNJPE]) {
                                                        ...
                                                        if (this.checkPermission(porpNJE)) {
                                                            lb_msg += "<span >" + jsn[auxy[i]][propN][propNJ][porpNJPE][porpNJE][0].toUpperCase() + " " + porpNJE.toUpperCase()  + ": </span><textarea class='input' style='width:100%;resize: none;overflow: hidden;' type='text' id='txt" + auxy[i] + "_" + porpNJE + "' >" + jsn[auxy[i]][propN][propNJ][porpNJPE][porpNJE][1] + "</textarea><br /> ";
                                                        } else {
                                                            lb_msg += "" + propN.toUpperCase() + ": <span style='width:80%' id='txt" + auxy[i] + "_" + propN + "'> " + jsn[auxy[i]][propN].toUpperCase()  + "</span>";
                                                        }
                                                        indice++;
                                                    }
                                                }
